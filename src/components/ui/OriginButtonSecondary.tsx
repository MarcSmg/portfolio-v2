...
const OriginButtonSecondary = React.forwardRef<HTMLButtonElement, OriginButtonProps>(
  (
    {
      children,
      className,
    ...
    return (
      <motion.button
        ...
        className={cn(
          "relative inline-flex cursor-pointer touch-manipulation select-none items-center justify-center overflow-hidden rounded-xl font-medium tracking-[-0.02em]",
      ...
      >
        <motion.span
          ...
          aria-hidden
          className="pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full bg-ui-surface"
          initial={false}
          style={{
            height: coverSize,
            left: origin.x,
        ...
        />
        <span className="relative z-10 flex items-center justify-between w-full h-full">
          {children}
        </span>
      </motion.button>
    );
...
OriginButtonSecondary.displayName = "OriginButton";

export { OriginButtonSecondary };
