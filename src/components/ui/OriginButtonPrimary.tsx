...
const OriginButtonPrimary = React.forwardRef<HTMLButtonElement, OriginButtonProps>(
  (
    {
      children,
      className,
    ...
    return (
      ...
      >
        <motion.span
          ...
          aria-hidden
          className="pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-emphasis"
          initial={false}
          style={{
            height: coverSize,
            left: origin.x,
...
OriginButtonPrimary.displayName = "OriginButton";

export { OriginButtonPrimary };
